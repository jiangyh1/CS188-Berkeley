...
def cornersHeuristic(state, problem):
    ...
    """
    corners = problem.corners  # These are the corner coordinates / self.corners = ((1,1), (1,top), (right, 1),
    # (right, top))
    ...
    for s in state[1]:
        visited.append(abs(s[0] - state[0][0]) + abs(s[1] - state[0][1]))
